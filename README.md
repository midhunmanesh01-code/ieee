...
**Use cases:** a project landing for IEEE SB CEC tasks, a simple event page, or a demo for web fundamentals.
...
**License**
© IEEE SB CEC — Contact your local chapter for reuse permissions.
